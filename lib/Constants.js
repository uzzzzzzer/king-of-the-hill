...
module.exports = {
  ...
  DRAWING_IMG_SELF_TANK: 'self_player',
  DRAWING_IMG_SELF_TURRET: 'self_turret',
  DRAWING_IMG_OTHER_TANK: 'self_player',
  DRAWING_IMG_OTHER_TURRET: 'self_player',
  DRAWING_IMG_SHIELD: 'shield',
  DRAWING_IMG_BULLET: 'bullet',
  DRAWING_IMG_TILE: 'tile',
  DRAWING_IMG_KEYS: [
    'self_player', 'self_turret', 'other_tank', 'other_turret', 'shield',
    'bullet', 'tile'
  ],
