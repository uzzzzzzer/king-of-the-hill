...
class Player extends Entity {
  ...
  updateOnInput(data) {
    if (data.up) {
      ...
      this.velocity = Vector.fromPolar(this.speed * Math.pow(0.99, Math.floor(this.army/200)), 270 / 180 * Math.PI);
    } else if (data.down) {
      //this.velocity = Vector.fromPolar(-this.speed, this.tankAngle)
      this.velocity = Vector.fromPolar(this.speed * Math.pow(0.99, Math.floor(this.army/200)), 90 / 180 * Math.PI);
    ...
    if (data.right) {
      ...
      this.velocity = Vector.fromPolar(this.speed * Math.pow(0.99, Math.floor(this.army/200)), 0 / 180 * Math.PI);
    } else if (data.left) {
      //this.turnRate = -Constants.PLAYER_TURN_RATE
      this.velocity = Vector.fromPolar(this.speed * Math.pow(0.99, Math.floor(this.army/200)), 180 / 180 * Math.PI);
